...
- 16, 24, 32, 48, 64, 128, 180, 192, 256, 384, and 512 pixels
...
- `Desktop Large`: ICO mode with 64, 128, and 256 pixels.
- `Web Favicon`: PNG mode with 32, 128, 180, 192, 384, and 512 pixels.
